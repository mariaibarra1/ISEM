...
namespace CatalogosService.Controllers
{
    ...
    public class EntesFiscalesController : Controller
    {
        private CaEnteFiscalNegocio negocio = new CaEnteFiscalNegocio();

        [HttpGet("[action]")]
        public IActionResult Consultar([FromQuery] CaEnteFiscalModel model)
        {
        ...
        [HttpPost("[action]")]
        public IActionResult Agregar([FromBody] CaEnteFiscalModel model)
        {
        ...
        [HttpPut("[action]")]
        public IActionResult Modificar([FromBody] CaEnteFiscalModel model)
        {
        ...
        [HttpDelete("[action]")]
        public IActionResult Eliminar([FromBody] CaEnteFiscalModel model)
        {
            model.tipoOperacion = (int) TipoOperacion.eliminar;
            return this.ProcesarTrasaccion(model);
        }

        private IActionResult ProcesarConsulta(CaEnteFiscalModel model)
        {
            try
            {
        ...
        private IActionResult ProcesarTrasaccion(CaEnteFiscalModel model)
        {
            try
            {

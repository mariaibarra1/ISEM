...
namespace CatalogosService.Controllers
{
    ...
    {
        private CaRubroNegocio negocio = new CaRubroNegocio();

        [HttpGet("[action]")]
        public IActionResult Consultar([FromQuery] CaRubroModel model)
        {
        ...
        private IActionResult ProcesarConsulta(CaRubroModel model)
        {
            try
            {
